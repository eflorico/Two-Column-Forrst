...
if (GM_getValue('two-column-lists') === undefined) {
	GM_setValue('two-column-lists', true);
	GM_setValue('two-column-comments', true);
}
...
else if (GM_getValue('two-column-comments') &&
...
//Settings page
	...
	//Load values
	if (GM_getValue('two-column-lists')) $('#two-column-lists').attr('checked', true);
	if (GM_getValue('two-column-comments')) $('#two-column-comments').attr('checked', true);
	...
	setInterval(function() {
		if (triggerSave) {
			GM_setValue('two-column-lists', $('#two-column-lists').is(':checked'));
			GM_setValue('two-column-comments', $('#two-column-comments').is(':checked'));
